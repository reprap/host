...
public class BooleanGrid {
    ...
    class iPolygon {
        ...
        /**
         * Find the index of the point in the polygon nearest to another point as long as it's less than tooFar2. Set
         * that to Long.MAX_VALUE for a complete search.
         * 
         * @param a
         * @param tooFar2
         * @return
        ...
        /**
         * Find the furthest point from point v1 on the polygon such that the polygon between the two can be
         * approximated by a DDA straight line from v1.
         * 
         * @param v1
         * @return
         */
    ...
    /**
     * Little class to hold the ends of hatching patterns. Snakes are a combination of the hatching lines that infill a
     * shape plus the bits of boundary that join their ends to make a zig-zag pattern.
     * 
     * @author ensab
     * 
     */
    ...
    /**
     * Lookup table for whether to cull points forming thin bridges. The index into this is the byte bitpattern implied
     * by the neighbour array. This table is generated interactively by the program
     * org.reprap.utilities.FilterGenerator.
     */
    private static final boolean[] thinFilter = { true, true, true, false, true, true, false, true, true, true, true,
        true, false, true, false, false, true, true, true, true, true, true, true, true, false, true, true, true, true,
        true, false, false, true, true, true, true, true, true, true, true, true, true, true, true, true, true, false,
        true, false, true, true, true, true, true, true, true, false, true, true, true, false, true, false, false,
        true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true, true,
        true, true, true, false, false, false, true, false, false, false, true, false, false, false, false, true, true,
        true, true, false, false, false, true, false, false, false, true, false, false, false, true, true, true, true,
        true, false, false, false, false, false, false, false, false, false, false, false, true, false, true, false,
        true, true, true, false, true, true, true, false, true, true, true, false, true, true, true, true, true, false,
        false, false, true, false, false, false, true, false, false, false, true, true, true, true, true, false, false,
        false, true, false, false, false, true, false, false, false, true, true, true, true, true, false, false, false,
        false, false, false, false, true, false, false, false, false, true, true, false, true, true, true, false, true,
        true, true, true, true, true, true, false, true, true, true, true, true, false, false, false, true, false,
        false, false, true, false, false, false, false, false, false, false, true, false, false, false, true, false,
        false, false, true, false, false, false, false, false, true, false, true, false, false, false, false, false,
    ...
    public BooleanGrid(RrCSG csgExp, RrRectangle rectangle, Attributes a) {
        ...
        rec.swCorner = new iPoint(ri.sw()); // That then gets subtracted by the iPoint constructor to give the true
                                            // origin
    ...
    /**
     * Get the value at the point corresponding to somewhere in the real world That is, membership test.
     * 
     * @param p
     * @return
     */
    ...
    private void generateQuadTree(iPoint ipsw, iPoint ipne, RrCSG csgExpression) {
        ...
        if (xd <= 1) {
            ...
            sw = new iPoint(x0, y0);
            ne = new iPoint(x0, ym);
            generateQuadTree(sw, ne, csgExpression.prune(new RrRectangle(Rr2Point.sub(sw.realPoint(), inc), Rr2Point
                .add(ne.realPoint(), inc))));
        ...
        generateQuadTree(sw, ne,
            csgExpression.prune(new RrRectangle(Rr2Point.sub(sw.realPoint(), inc), Rr2Point.add(ne.realPoint(), inc))));
    ...
    /**
     * Is a pixel on an edge? If it is solid and there is air at at least one of north, south, east, or west, then yes;
     * otherwise no.
     * 
     * @param a
     * @return
    ...
    /**
     * Find the index in the bitmap of the next unvisited edge pixel after-and-including start. Return -1 if there isn't
     * one.
     * 
     * @param start
     * @return
    ...
    /**
     * Remove whiskers (single threads of pixels) and similar nasties. TODO: also need to do the same for cracks?
     * 
     */
    ...
    /**
     * Find a neighbour of a pixel that has not yet been visited, that is on an edge, and that is nearest to a given
     * neighbour direction, nd. If nd < 0 the first unvisited neighbour is returned. If no valid neighbour exists, null
     * is returned. This prefers to visit valid pixels with few neighbours, and only after that tries to head in
     * direction nd.
     * 
     * @param a
     * @param direction
    ...
    /**
     * Recursive flood-fill of solid pixels from p to return a BooleanGrid of just the shape connected to that pixel.
     * 
     * @param p
     * @return
     */
    ...
    /**
     * Return all the outlines of all the solid areas as polygons consisting of all the pixels that make up the
     * outlines.
     * 
     * @return
     */
    ...
    /**
     * Return all the outlines of all the solid areas as polygons in their simplest form.
     * 
     * @return
     */
                ...
                case 6:
                    ...
                    if (!get(here)) {
                        if (result.size() > 1) {
                            ...
                            here = result.point(result.size() - 1);
                            if (!get(here)) {
                                Debug.e("BooleanGrid.marchRound() - backtracked to an unfilled point!"
                                    + printNearby(here, 4) + "\n\n");
                                result.remove(result.size() - 1);
                                here = result.point(result.size() - 1);
                            }
    ...
    /**
     * Generate a sequence of point-pairs where the line h enters and leaves solid areas. The point pairs are stored in
     * a polygon, which should consequently have an even number of points in it on return.
     * 
     * @param h
     * @return
     */
    ...
    /**
     * Find the bit of polygon edge between start/originPlane and targetPlane TODO: origin == target!!!
     * 
     * @param start
     * @param hatches
     * @param originP
    ...
    /**
     * Take a list of hatch point pairs from hatch (above) and the corresponding lines that created them, and stitch
     * them together to make a weaving snake-like hatching pattern for infill.
     * 
     * @param ipl
     * @param hatches
     * @param thisHatch
    ...
    /**
     * Offset the pattern by a given real-world distance. If the distance is negative the pattern is shrunk; if it is
     * positive it is grown;
     * 
     * @param dist
     * @return
     */
    ...
    /**
     * Complement a grid N.B. the grid doesn't get bigger, even though the expression it contains may now fill the whole
     * of space.
     * 
     * @return
     */
    ...
    /**
     * Grid d - grid e, forcing attribute a on the result d's rectangle is presumed to contain the result. TODO: write a
     * function to compute the rectangle from the bitmap
     * 
     * @param d
     * @param e
     * @param a
    ...
    /**
     * Grid d - grid e d's rectangle is presumed to contain the result. TODO: write a function to compute the rectangle
     * from the bitmap
     * 
     * @param d
     * @param e
