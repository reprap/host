...
public class RrHalfPlane {
     ...
     * @param b
     * @param tolerance
     * @return 0 if the distance between halfplane a and b is less then the tolerance, -1 if one is the complement of
     *         the other within the tolerance, otherwise 1
     */
    ...
    public RrInterval value(RrRectangle b) {
        return RrInterval.add(RrInterval.add((RrInterval.mul(b.x(), normal.x())), (RrInterval.mul(b.y(), normal.y()))),
            offset);
    }
    ...
    /**
     * Take a range of parameter values and a line, and find the intersection of that range with the part of the line
