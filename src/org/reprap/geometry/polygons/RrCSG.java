 ...
 * 
 * RrCSG: 2D polygons as boolean combinations of half-planes First version 14 November 2005
 */
public class RrCSG {
    ...
    /**
     * This takes a complicated expression assumed to contain multiple instances of leafA and returns the equivalent CSG
     * expression involving just leafA.
     * 
     * @param leafA
    ...
    /**
     * This takes a complicated expression assumed to contain multiple instances of leafA and leafB and returns the
     * equivalent CSG expression involving at most leafA and leafB once (except for non-manifold shapes).
     * 
     * @param leafA
     * @param leafB
    ...
    /**
     * Run through a GSG expression looking at its leaves and return a list of the distinct leaves. Note: leaf and
     * leaf.complement() are not considered distinct. Recursive internal call.
     * 
     * @param expression
     * @return
     */
    ...
    /**
     * Run through a GSG expression looking at its leaves and return a list of the distinct leaves. Note: leaf and
     * leaf.complement() are not considered distinct.
     * 
     * @param expression
     * @return
     */
