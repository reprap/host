 ...
 * 
 * But sometimes you need to attach some information to an individual polygon to be plotted. For example, you might want
 * to know to plot it with less material than normal so it tends to stretch out.
 * 
...
public class PolygonAttributes {
    ...
    public void setBridgeThin(double bt) {
        bridgeThin = bt;
    }
