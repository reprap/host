...
public class BotConsoleFrame extends javax.swing.JFrame {
    ...
    /**
     * The update thread calls this to update everything that relies on information from the RepRap machine.
     */
    ...
    /**
     * The update thread calls this to update everything that is independent of the RepRap machine.
     * 
     * @param fractionDone
     */
    ...
    /**
     * "Suspend" and "resume" the poll thread. We don't use the actual suspend call (depricated anyway) to prevent
     * resource locking.
     * 
     */
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
            layout
                ...
                .add(jTabbedPane1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 750,
                    org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).addContainerGap(5, Short.MAX_VALUE)));
        layout.setVerticalGroup(layout.createParallelGroup(org.jdesktop.layout.GroupLayout.LEADING).add(
            layout
                .createSequentialGroup()
                .add(jTabbedPane1, org.jdesktop.layout.GroupLayout.PREFERRED_SIZE, 400,
                    org.jdesktop.layout.GroupLayout.PREFERRED_SIZE).addContainerGap(5, Short.MAX_VALUE)));
