    ...
    public void postSetUp(int m) throws IOException {
        ...
        switch (motorID) {
            case 1:
                ...
                axisLength = Preferences.loadGlobalDouble("WorkingX(mm)"); // TODO: Replace with Prefs when Java3D
                                                                           // parameters work for small wv's.
                break;
            case 2:
                axis = "Y";
                // motor = printer.getYMotor();
                axisLength = Preferences.loadGlobalDouble("WorkingY(mm)"); // TODO: Replace with Prefs when Java3D
                                                                           // parameters work for small wv's.
                break;
            case 3:
                axis = "Z";
                // motor = printer.getZMotor();
                axisLength = Preferences.loadGlobalDouble("WorkingZ(mm)"); // TODO: Replace with Prefs when Java3D
                                                                           // parameters work for small wv's.
                break;
            default:
                axis = "X";
        ...
        // motor = new GenericStepperMotor(communicator, new SNAPAddress(address), Preferences.getGlobalPreferences(),
        // motorID);

        // motorStepsPerMM = Preferences.loadGlobalDouble(axis + "AxisScale(steps/mm)");

        // TODO: Activate this code when the Java3D parameters allow a small enough working volume. Currently I get a
        // black screen.
    ...
    private void initComponents() {
        ...
        layout.setHorizontalGroup(layout.createParallelGroup(javax.swing.GroupLayout.Alignment.LEADING).addGroup(
            layout
                ...
                .addGap(4, 4, 4)
                .addComponent(targetPosition, javax.swing.GroupLayout.PREFERRED_SIZE,
                ...
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.UNRELATED)
                .addComponent(storeButton, javax.swing.GroupLayout.DEFAULT_SIZE, 64, Short.MAX_VALUE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED)
                .addComponent(recallButton)
                .addGap(3, 3, 3)
                .addComponent(storedPosition, javax.swing.GroupLayout.PREFERRED_SIZE, 50,
                    javax.swing.GroupLayout.PREFERRED_SIZE)
                .addPreferredGap(javax.swing.LayoutStyle.ComponentPlacement.RELATED).addComponent(mmLabel2)
                .addContainerGap()));
            ...
            layout
                ...
                .addGroup(
                    layout
                        ...
                        .addComponent(recallButton)
                        .addComponent(storedPosition, javax.swing.GroupLayout.PREFERRED_SIZE, 15,
                            javax.swing.GroupLayout.PREFERRED_SIZE).addComponent(mmLabel2))
