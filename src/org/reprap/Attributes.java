...
/**
 * Small class to hold RepRap attributes that are attached to Java3D shapes as user data, primarily to record the
 * material that things are made from.
 * 
 * @author adrian
 * 
 */
public class Attributes {
    ...
    /**
     * The extruder corresponsing to this material. This is lazily evaluated (I.e. it is not set until there are some
     * extruders around to use).
     */
    private Extruder e;
     ...
     * @param b
     */
    public void setPart(BranchGroup b) {
        part = b;
    }
