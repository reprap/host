...
public interface Printer {
     ...
     * 
     * @param x
     *            absolute x position in millimeters relative to the home position. Range between [0..???]
     * @param y
     *            absolute y position in millimters relative to the home position. Range betwen [0..???]
     * @param z
     *            absolute z position in millimters relative to the home position. Range between [0..???]
     * @param startUp
     *            ?
     * @param endUp
     *            ?
     ...
     * @throws Exception
     */
    public void moveTo(double x, double y, double z, double feedrate, boolean startUp, boolean endUp)
        throws ReprapException, IOException, Exception;
     ...
     *            absolute z position in millimters relative to the home position. Range between [0..???]
     * @param lastOne
     *            True if extruder should be turned off at end of this segment.
     * @throws ReprapException
     * @throws IOException
     * @throws Exception
     */
     ...
     * 
     * @param firstOneInLayer
     *            (first after the layer pause, or any old polygon?)
     */
    ...
    /**
     * Tell the printer class it's Z position. Only to be used if you know what you're doing...
     * 
     * @param z
     */
    ...
    /**
     * The next time an extruder is changed, force the change to be sent to the RepRap, even if it's changed to the same
     * as it just was.
     */
    ...
    /**
     * Allow the user to manually calibrate the Z axis position to deal with special circumstances like different
     * extruder sizes, platform additions or subtractive fabrication.
     * 
     * @throws IOException
     */
     ...
     * 
     * @param zeroPoint
     *            The point the user selects will be treated as the given Z value rather than 0.0
     */
     ...
     * 
     * @param segmentPause
     *            The source checkbox used to determine if there should be a pause. This is a checkbox rather than a
     *            boolean so it can be changed on the fly.
     */
    ...
    //
    /**
     * If we are using an output buffer, it's a good idea to wait till it's empty between layers before computing the
     * next one.
     */
    ...
    /**
     * All machine dwells and delays are routed via this function, rather than calling Thread.sleep - this allows them
     * to generate the right G codes (G4) etc.
     * 
    ...
    /**
     * Load a file to be made. Currently these can be STLs (more than one can be loaded) or a GCode file, or an .rfo
     * file.
     * 
    ...
    /**
     * Set the bed temperature. This value is given in centigrade, i.e. 100 equals 100 centigrade.
     * 
     * @param temperature
    ...
    /**
     * Wait till the entire machine is ready to print. That is that such things as extruder and bed temperatures are at
     * the values set and stable.
     * 
     * @throws Exception
     */
