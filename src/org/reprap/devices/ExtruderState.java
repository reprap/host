...
/**
 * Tiny class to hold the length of filament that an extruder has extruded so far, and other aspects of the state of the
 * extruder. This is used in the extruder class. All logical extruders that correspond to one physical extruder share a
 * single instance of this class. This means that (for example) setting the temperature of one will be reflected
