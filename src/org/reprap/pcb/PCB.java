...
public class PCB {
    ...
    private void createBitmap() {
        ...
        try {
            ...
            BooleanGrid pattern = new BooleanGrid(RrCSG.nothing(), bigBox, new Attributes(null, null, null,
                pcbPen.getAppearance()));
    ...
    private RrRectangle processLine(String line, boolean drill) {
        ...
        } else if (line.startsWith("T") && drill && line.length() > 3) {
            if (line.charAt(3) == 'C') {
        ...
        } else if (line.startsWith("G70") || (drill && line.startsWith("M72"))) {
            scale = 25.4;
            Debug.d("Inches");
        } else if (line.startsWith("G71") || (drill && line.startsWith("M71"))) {
            scale = 1;
            Debug.d("Metric");
        ...
        } else if (line.startsWith("D") || (line.startsWith("T") && drill && !drillDef)) {
            if (drill) {
                gerberGcode.selectAperture(-1);
                Debug.d("Drill centre selected.");
            } else {
