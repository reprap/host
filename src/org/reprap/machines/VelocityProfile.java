...
/**
 * Small class to compute the optimum velocity profile given a starting and an ending velocity, a maximum velocity that
 * cannot be exceeded, and an acceleration.
 * 
 * The result is either a single maximum velocity, v, inbetween the ends (in which case flat will be 1), or an
 * acceleration to maxSpeed at s1 from the start, movement at that velocity to s2, then deceleration to the end (in
