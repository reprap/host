...
public class Debug {
    ...
    /**
     * Print a debug message to system out if the Debug property is set in the preferences file.
     * 
     * @param s
     */
    ...
    /**
     * Used to print a trace of the comms if the 'CommsDebug' flag is set in the preferences file.
     * 
     * @param s
     */
